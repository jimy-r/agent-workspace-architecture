...
**Where it lives:** [`samples/CLAUDE.md.example`](samples/CLAUDE.md.example) carries the read-in-subagent, ranged-read, batch-calls, protect-the-cache, and compact-on-purpose rules as a standing directive. Pattern 9 frames context as a budget; this prices that budget by position and step-count.
